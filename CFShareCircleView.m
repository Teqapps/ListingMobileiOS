...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        _sharers = [[NSMutableArray alloc] initWithObjects: [CFSharer pinterest], [CFSharer googleDrive], [CFSharer twitter], [CFSharer facebook], [CFSharer whatsapp], [CFSharer dropbox], [CFSharer mail], [CFSharer photoLibrary], nil];
